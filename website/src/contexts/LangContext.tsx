...
const t: Record<string, Record<Lang, string>> = {
  ...
  'home.tag':         { en: 'Adaptive Vocal-Aware Backing Rider', zh: '自适应人声感知伴奏增益减益器' },
  'home.f1':          { en: 'Real-time vocal detection with intelligent gain riding', zh: '实时人声检测 + 智能增益减益' },
  ...
  'reg.code':         { en: 'Verification Code', zh: '验证码' },
  'reg.sendCode':     { en: 'Send Code',        zh: '获取验证码' },
  'reg.sending':      { en: 'Sending...',       zh: '发送中...' },
  'reg.resendIn':     { en: 'Resend in {s}',    zh: '{s}秒后重发' },
  'reg.codeSent':     { en: 'Code sent! Check your inbox.', zh: '验证码已发送！请查收邮件。' },
  ...
  'reg.invalidCode':  { en: 'Invalid or expired verification code', zh: '验证码无效或已过期' },
